package Program;
/**
 * Class CMPZ (compare to 0) provides an implementation of the 
 * Instruction class that sets the accumulator to 1 if an argument is 
 * zero and 0 otherwise, using direct addressing.
 * @author CS 140
 *
 */
public class CMPZ extends Instruction {
	...
	/**
	 * Implementation of the CMPZ Instruction.
	 * Ignore the indirect flag
	 * If the data value stored at location arg in the data of the 
	 * program is 0, set the accumulator to 1 and otherwise
